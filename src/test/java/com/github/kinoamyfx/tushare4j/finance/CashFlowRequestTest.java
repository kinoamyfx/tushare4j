...
public class CashFlowRequestTest {
    @Test
    public void test() throws IOException, TuShareException {
        ...
        List<CashFlow> call = TuShareClientTest.client.call(request);

        CodeUtils.assertFields(call, Arrays.stream(CashFlow.class.getDeclaredFields()).map(Field::getName).collect(Collectors.toList()));
    }
}